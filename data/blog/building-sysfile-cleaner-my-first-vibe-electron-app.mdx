---
title: 'Building SysFile Cleaner: My First Electron App'
date: '2024-04-24'
...
## Building SysFile Cleaner: My First Electron App

I'm excited to share the story of how I built my first desktop application using Electron.js - [SysFile Cleaner](https://github.com/mdrathik/SysFile-Cleaner). This project wasn't just a technical exercise; it was fun to solve that specific problem.
...
- 🔍 Scans directories recursively for system metadata files
...
- Currently, I haven't any future plans. Because it's a very tiny app for a tiny problem that makes us crazy.
