export default function Privacy() {
  return (
    <>
      <div>
        <h1>Privacy Policy for rathik.dev</h1>
        <br></br>
        <p>
          At Rathik.dev, accessible from https://www.rathik.dev/, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that
          is collected and recorded by Rathik.dev and how we use it.
        </p>
        <br></br>
        <p>
        ...
        <p>
          ...
          website with regards to the information that they shared and/or collect in Rathik.dev.
        ...
        <h2>Log Files</h2>
        <p>
          Rathik.dev follows a standard procedure of using log files. These files log visitors when
        ...
        <p>
          ...
          Rathik.dev, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>
          Note that Rathik.dev has no access to or control over these cookies that are used by
          third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          Rathik.dev's Privacy Policy does not apply to other advertisers or websites. Thus, we are
        ...
        <p>
          Rathik.dev does not knowingly collect any Personal Identifiable Information from children
